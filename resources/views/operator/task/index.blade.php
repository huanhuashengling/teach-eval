        ...
        <div class="min-w-full border-b border-gray-200 shadow overflow-x-auto">
            ...
            <x-admin.grid.table>
                <x-slot name="head">
                    <tr>
                        <x-admin.grid.th>
                            @include('admin.includes.sort-link', ['label' => '任务内容', 'attribute' => 'name'])
                        </x-admin.grid.th>
                        <x-admin.grid.th>
                            @include('admin.includes.sort-link', ['label' => '任务类型', 'attribute' => 'task_types_id'])
                        </x-admin.grid.th>
                        <x-admin.grid.th>
                            @include('admin.includes.sort-link', ['label' => '人员类型', 'attribute' => 'participant_types_id'])
                        </x-admin.grid.th>
                        <x-admin.grid.th>
