...
<x-app-layout>
	...
	<div class="grid gap-4 grid-cols-5">
		...
		<div>
			<a href="{{ route('operator.report.export') }}"><button type="button" class="focus:outline-none text-white bg-green-400 hover:bg-green-500 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-green-900">表格导出</button></a>
		</div>
	</div>
</form>
    </x-slot>
